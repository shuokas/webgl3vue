...
const initScenes = () => {
    ...
    let animation = gsap.to(cube.position, { duration: 2.5, ease: "bounce.out", x: 5, repeat: -1, yoyo: true, onComplete: () => {
        console.log("动画完成");
    } });
    ...
    gsap.to(cube.rotation, { x: 2 * Math.PI , duration: 2.5, ease: "bounce.out", repeat: -1, yoyo: true });
    // resize
